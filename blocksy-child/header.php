	...
	<header class="header">
			...
			<div class="container-fluid">
				<div class="header__wrapper d-flex justify-content-between align-items-center">
					<div class="header-top__left d-flex align-items-center justify-content-start">
						...
						<button class="button city-choose-btn d-none d-md-flex" data-popup-open="city-popup">
					...
					<div class="header-top__right d-flex align-items-center justify-content-end">
						...
						if ($tel && $phone_num) { ?>
							<a class="header__link tel col-auto" href="tel:+7<?php echo $tel; ?>">
								<?php echo $phone_num; ?>
							</a>
						<?php }
						?>
		...
		<div class="header__bottom">
			<div class="container-fluid d-flex justify-content-between align-items-center">
				<nav id="navbar" class="header-center__nav d-flex flex-column justify-content-between">
					<button class="d-block d-xl-none header-center__close burger-close">
					...
					<div
						class="header-center__bottom header-bottom d-flex d-xl-none align-items-center justify-content-between">
						<?php
						if ($tel && $phone_num) { ?>
						...
						// Этот блок добавляем когда подключены ACF
						get_template_part('template-parts/social');
						?>
					</div>
				</nav>

				<button class="button header__btn d-none d-xl-flex" data-popup-open="zakaz-popup">
					Заказать звонок
				</button>
			</div>
		</div>
