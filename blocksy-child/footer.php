...
<footer class="footer">
    <div class="container">
        <div
            class="footer__top d-flex flex-column flex-lg-row align-items-start align-items-md-center justify-content-md-between">
            <?php
            if ($logo_white) { ?>
                <a href="/" class="footer__logo d-none d-md-block">
                    <img src="<?php echo $logo_white['url']; ?>" alt="<?php echo $logo_white['alt']; ?>">
                </a>
            <?php } ?>

            <button class="button city-choose-btn col-auto" data-popup-open="city-popup">
                <span>Выбрать город отправки</span>
            </button>

            <?php
            echo '<div class="hero__social col-auto">';
            get_template_part('template-parts/social');
            echo '</div>'; ?>
        </div>

        <div class="footer__medium footer-medium d-flex flex-column flex-lg-row justify-content-between">
            <div class="footer-medium__links footer-menu-wrap d-flex flex-column flex-md-row">
                <?php
            ...
            <div class="footer-medium__links footer-links">
                <?php if ($phone_num) { ?>
                    <div class="footer-links-tel__item d-flex align-items-center gap-3 mb-2">
                        <p>Общий телефон:</p>
                    ...
                    <ul class="footer-links__tel footer-links-tel">
                        <?php if (have_rows('footer_phones', 'options')) { ?>
                            <?php while (have_rows('footer_phones', 'options')) {
                                the_row();
                                $footer_phone_text = get_sub_field('footer_phone_text', 'options');
                                $footer_phone_num = get_sub_field('footer_phone_num', 'options');
                                ?>
                                <li class="footer-links-tel__item d-flex align-items-center justify-content-lg-end gap-3 mb-2">
                                    <p><?php echo $footer_phone_text; ?></p>
                                    <a href="tel:<?php echo $footer_phone_num; ?>"><?php echo $footer_phone_num; ?></a>
                                </li>
                ...
                if ($email) { ?>
                    <div class="footer-links-tel__item d-flex align-items-center justify-content-lg-end gap-3">
                        <p>E-mail:</p>
        ...
        <div class="footer__down footer-down">
            <div
                class="footer-down__wrap d-flex flex-column flex-lg-row align-items-start align-items-lg-center gap-xl-3 justify-content-start justify-content-xl-between">
    ...
    <div class="popup__wrapper">
        <div class="popup__cont zakaz-cont">
            ...
            <h3 class="popup__heading">
                Заполните пару полей&nbsp;и мы ответим в&nbsp;самое ближайшее время!
            </h3>

            <?php
            echo do_shortcode('[contact-form-7 id="6423576" title="Заказать звонок в попапе"]'); ?>
        </div>
    </div>
</section>

<!-- Попап Заказать -->
<section data-popup="city-popup" class="popup city">
    <div class="popup__wrapper city">
        <div class="popup__cont city-cont">
            <button data-popup-close="city-popup" class="popup__del">
                <!-- <i class="fa fa-times"></i> -->
                <svg width="26" height="26" viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                        d="M19.3848 17.9705L2.41431 1L1.00009 2.41421L17.9706 19.3847L1 36.3553L2.41421 37.7696L19.3848 20.7989L36.3554 37.7696L37.7696 36.3553L20.799 19.3847L37.7696 2.41422L36.3553 1.00001L19.3848 17.9705Z"
            ...
            $query_cities = new WP_Query($arg_cities);
            ?>

            <ul class="city-list d-flex flex-wrap align-items-start">
                <?php
                if ($query_cities->have_posts()) {
                    while ($query_cities->have_posts()) {
                        $query_cities->the_post();
                        ?>
