            ...
            <ul class="autopark__list autopark-list d-grid grid-four">
                <?php if (have_rows('new_truck', 'options')) {
                    ...
                    <?php while (have_rows('new_truck', 'options')) {
                        ...
                        <li class="autopark-list__item autopark-item position-relative" data-aos="fade-up" data-aos-offset="200"
                            data-aos-delay="<?php echo 100 * ($indext * 2); ?>" data-aos-duration="900"
                            data-aos-easing="ease-in-out" data-aos-once="true" data-aos-anchor-placement="bottom"
                            class="digits-list__item digit-item">
                            ...
                            <figure class="autopark-item__image">
                                <img src="<?php echo $new_truck_image['url']; ?>" alt="<?php echo $new_truck_image['alt']; ?>">
                            </figure>
                        </li>
